...
o To launch the app, navigate to the main.py file's directory within your Python virtual environment and run the following command:
- streamlit run main.py
o After executing the command, the application will automatically open in your web browser.
...
o Because of this, the primary metric for model evaluation was the confusion matrix.
o However, the validation charts were still very useful for identifying issues like underfitting or overfitting in real-time.
